...
impl AnyVfsFile {
    ...
    /// [`WritablePageSource::from_file`](crate::WritablePageSource::from_file),
...
impl FileLock {
    ...
    /// [`crate::lock::FileLockState::set_level`]) so a concurrent
    ...
    /// needed (see [`crate::lock::FileLockState::set_level`]).
