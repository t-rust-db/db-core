...
use sql_sys::fcntl::{off_t, EACCES, EAGAIN, F_RDLCK, F_UNLCK, F_WRLCK, O_NOFOLLOW};
...
mod tests {
    ...
    use crate::test_lock_probe::{hold_multiple, release_all};
    ...
    fn unix_vfs_surfaces_locked_error_when_all_slots_contended() {
        use crate::{companion_path, UnixVfs, Vfs, VfsError};
