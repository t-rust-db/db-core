...
mod tests {
    ...
    /// MC/DC vector (obligation `vm_row_cast_downgrade_whole_reals_930ffc0f`, `downgrade_whole_reals`'s
    ...
    fn mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v1_whole_finite_in_range_downgrades() {
        assert_eq!(cast_to(&text("5.0"), Affinity::Numeric), Value::Integer(5));
    }

    /// MC/DC vector (obligation `vm_row_cast_downgrade_whole_reals_930ffc0f`): leaf A (`fract() == 0.0`)
    /// false -- a fractional REAL stays REAL. Independence pair for A
    /// against `mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v1_whole_finite_in_range_downgrades`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v2_fractional_real_stays_real() {
        assert_eq!(cast_to(&text("5.5"), Affinity::Numeric), Value::Real(5.5));
    }

    /// MC/DC vector (obligation `vm_row_cast_downgrade_whole_reals_930ffc0f`): leaf B (`is_finite()`)
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v3_infinite_real_stays_real() {
    ...
    /// MC/DC vector (obligation `vm_row_cast_downgrade_whole_reals_930ffc0f`): leaf C (`in_i64_range`)
    /// false, leaves A and B true -- a whole, finite REAL outside
    /// `i64`'s range stays REAL. Independence pair for C against
    /// `mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v1_whole_finite_in_range_downgrades`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__vm_row_cast_downgrade_whole_reals_930ffc0f__v4_out_of_range_whole_real_stays_real() {
