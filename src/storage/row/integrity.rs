...
use crate::storage::row::btree::{IndexCursor, IndexRow, TableCursor};
use crate::storage::row::header::DatabaseHeader;
use crate::storage::row::pager::freelist::TrunkPage;
use crate::storage::row::record::{decode_record, Value};
use crate::storage::row::schema::{read_schema, IndexSchema, TableSchema};
...
mod tests {
    ...
    use super::*;
    use crate::storage::row::record::TextEncoding;
    use crate::storage::row::schema::IndexedColumn;
    ...
    fn index_schema(name: &str, root_page: u32) -> IndexSchema {
        IndexSchema {
            ...
            columns: vec![IndexedColumn {
                name: "a".to_string(),
                desc: false,
                collation: crate::storage::row::record::Collation::Binary,
            }],
            root_page,
        }
    }
