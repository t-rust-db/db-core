...
pub fn populate_index_from_table(
    ...
    {
        let mut cursor =
            crate::storage::row::btree::TableCursor::new(&*pager, header, table_root_page);
...
mod tests {
    use super::*;
    use crate::storage::row::btree::{insert_row, MasterEntry};
    ...
    fn create_empty_table_root_is_a_readable_empty_leaf() {
        ...
        let mut cursor = crate::storage::row::btree::TableCursor::new(&pager, &header, root);
    ...
    fn create_empty_index_root_is_a_readable_empty_leaf() {
        ...
        let mut cursor =
            crate::storage::row::btree::IndexCursor::new(&pager, header.usable_page_size(), root);
        assert!(cursor.first().unwrap().is_none());
    }
    ...
    fn populate_index_from_table_covers_existing_rows() {
        ...
        let mut cursor = crate::storage::row::btree::IndexCursor::new(
            &pager,
