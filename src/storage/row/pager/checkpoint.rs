...
use crate::storage::row::vfs::{companion_path, AnyVfs};
...
mod tests {
    ...
    fn reader_mark_bounds_the_checkpoint() {
        use crate::storage::row::vfs::shm::wal_read_lock_byte;
        use crate::storage::row::vfs::test_lock_probe::{hold_multiple, release_all};
