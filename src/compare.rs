...
//! sqlite-rs's `vdbe::compare` (ADR 0008). Crate-root, feature-free
//! (ADR 0011/#122, mirroring [`crate::value`]'s ADR 0010 hoist):
//! `vm::row` re-exports it, `vm::batch`/`vm::stream` can call it
//! directly.

use std::cmp::Ordering;

use crate::value::{compare_text, Collation, Value};
