...
pub enum Keyword {
    ...
    /// The `SET` keyword.
    SET,
    /// The `SINCE` keyword (ADR 0018 stream scope).
    SINCE,
    /// The `TABLE` keyword.
    TABLE,
    /// The `TEMP` keyword.
    ...
    /// The `UNIQUE` keyword.
    UNIQUE,
    /// The `UNTIL` keyword (ADR 0018 stream scope).
    UNTIL,
    /// The `UPDATE` keyword.
    UPDATE,
    /// The `USING` keyword.
...
impl Tokenizer {
    ...
    fn span_from(&self, start: (u32, u32, u32)) -> Span {
        let end_offset = u32::try_from(self.pos).unwrap_or(u32::MAX);
        Span {
            line: start.0,
            column: start.1,
            offset: start.2,
        ...
        if self.peek_char(src) == Some('0') && matches!(self.peek_at(src, 1), Some('x' | 'X')) {
            ...
            return match i64::from_str_radix(hex, 16) {
                ...
                Err(_) => match u64::from_str_radix(hex, 16) {
                    // SQLite hex literals above `i64::MAX` wrap to their
                    // two's-complement value (`0xFFFFFFFFFFFFFFFF` is -1).
                    Ok(n) => TokenKind::Integer(i64::from_ne_bytes(n.to_ne_bytes())),
...
mod tests {
    ...
    fn mcdc__parser_row_tokenizer_next_token_95992c1d__v1_lowercase_x() {
        assert_eq!(
            kinds("x'41'"),
    ...
    /// `mcdc__parser_row_tokenizer_next_token_95992c1d__v1_lowercase_x`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_next_token_95992c1d__v2_neither_x_nor_capital_x() {
        assert_eq!(
            kinds("y"),
    ...
    /// `mcdc__parser_row_tokenizer_next_token_95992c1d__v2_neither_x_nor_capital_x`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_next_token_95992c1d__v3_uppercase_x() {
        assert_eq!(
            kinds("X'41'"),
            vec![TokenKind::Blob(Box::new(vec![0x41])), TokenKind::Eof]
        );
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_maybe_blob_c47c3091__v1_odd_digit_count() {
    ...
    /// Independence pair for A against
    /// `mcdc__parser_row_tokenizer_scan_maybe_blob_c47c3091__v1_odd_digit_count`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_maybe_blob_c47c3091__v2_valid_hex() {
        assert_eq!(
            kinds("x'41'"),
            vec![TokenKind::Blob(Box::new(vec![0x41])), TokenKind::Eof]
        );
    ...
    /// `mcdc__parser_row_tokenizer_scan_maybe_blob_c47c3091__v2_valid_hex`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_maybe_blob_c47c3091__v3_even_length_non_hex_digit() {
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_quoted_identifier_aa1fa4b7__v1_escaped_doubled_delimiter() {
        assert_eq!(
            kinds(r#""a""b""#),
            vec![TokenKind::Identifier("a\"b".to_string()), TokenKind::Eof]
        );
    ...
    /// `mcdc__parser_row_tokenizer_scan_quoted_identifier_aa1fa4b7__v1_escaped_doubled_delimiter`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_quoted_identifier_aa1fa4b7__v2_bracket_identifier_does_not_escape(
    ) {
        assert_eq!(
            kinds("[abc]"),
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_quoted_identifier_aa1fa4b7__v3_unescaped_double_quoted() {
        assert_eq!(
            kinds("\"abc\""),
            vec![TokenKind::Identifier("abc".to_string()), TokenKind::Eof]
        );
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_number_07c2b2c9__v1_hex_prefix() {
    ...
    /// against `mcdc__parser_row_tokenizer_scan_number_07c2b2c9__v1_hex_prefix`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_number_07c2b2c9__v2_not_leading_zero() {
    ...
    /// `mcdc__parser_row_tokenizer_scan_number_07c2b2c9__v1_hex_prefix`.
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_number_07c2b2c9__v3_leading_zero_not_hex() {
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_identifier_or_keyword_2f93ed48__v1_alphanumeric_bytes_extend_the_identifier(
    ) {
        assert_eq!(
            first_kind("ab12 x"),
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_identifier_or_keyword_2f93ed48__v2_underscore_extends_the_identifier(
    ) {
        assert_eq!(
            first_kind("a_b x"),
    ...
    #[test]
    #[allow(non_snake_case)]
    fn mcdc__parser_row_tokenizer_scan_identifier_or_keyword_2f93ed48__v3_any_other_ascii_byte_ends_the_identifier(
    ) {
