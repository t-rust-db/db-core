...
/// `ANALYZE`-derived [`crate::codegen::row::planner::Stats`] (#485), threaded down to
...
pub fn compile_select_with_catalog_and_stats(
    ...
    match &from.first.kind {
        ...
        TableRefKind::Subquery(subquery) => {
            crate::codegen::row::subquery::materialize_from_subquery(
                &mut em,
                &mut reg,
                subquery,
                catalog,
...
/// [`crate::codegen::row::subquery::materialize_from_subquery`], the same
