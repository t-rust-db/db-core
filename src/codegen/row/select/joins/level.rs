...
pub(in crate::codegen::row::select) fn resolve_join_constraint(
    join: &Join,
    left: &[TableBinding],
    right: &TableBinding,
    right_idx: usize,
...
#[derive(Debug, Clone)]
pub(in crate::codegen::row::select) struct LevelCheck {
...
pub(in crate::codegen::row::select) struct LevelPlan {
...
pub(in crate::codegen::row::select) fn compile_join_level<F>(
    em: &mut Emitter,
    reg: &mut RegAlloc,
    select: &Select,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::codegen::row::select) fn compile_join_level_traverse<L>(
    em: &mut Emitter,
    reg: &mut RegAlloc,
    exec_bindings: &[TableBinding],
    orig_bindings: &[TableBinding],
...
#[allow(clippy::too_many_arguments)]
pub(in crate::codegen::row::select) fn emit_join_final_row<F>(
    em: &mut Emitter,
    reg: &mut RegAlloc,
    select: &Select,
    scope: &Scope,
...
pub(in crate::codegen::row::select) fn emit_join_distinct_guard(
    em: &mut Emitter,
    reg: &mut RegAlloc,
    select: &Select,
    scope: &Scope,
