...
use sql_vfs::{AnyVfs, AnyVfsFile, VfsError};
...
impl JournalHeader {
    ...
    /// [`crate::JOURNAL_MAGIC`] is exposed for callers that haven't.
...
/// [`sql_vfs::Vfs::delete`] the journal (DELETE mode, #172).
///
...
impl JournalWriter {
    ...
    pub fn create(
        ...
        let header_bytes = header.serialize(crate::JOURNAL_MAGIC);
        region
...
/// What [`recover`] restored — [`crate::recover_hot_journal`] uses
